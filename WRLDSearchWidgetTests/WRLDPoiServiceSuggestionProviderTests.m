...
{
    OCMStub([m_mockPoiService searchAutocomplete:[OCMArg any]]).andReturn(m_mockPoiSearchToCompletion);
...
{
    OCMStub([m_mockPoiService searchAutocomplete:[OCMArg any]]).andReturn(m_mockPoiSearchToCancel);
